import type { StatInterfaceProps } from '../StatInterface.vue'
import type { StatModifier } from '@/sheet/stores/statsStore/statsStore'
...
function doAttributeRender({ stat: attribute = 'CONTROL' }: AttributeRenderProps = {}) {
...
function doDepartmentRender({ stat: department = 'COMMAND' }: DepartmentRenderProps = {}) {
  const mounted = render(StatInterface, {
    props: {
      stat: department,
    },
